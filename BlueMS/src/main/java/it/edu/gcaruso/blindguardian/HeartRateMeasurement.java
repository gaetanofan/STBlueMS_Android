...
public class HeartRateMeasurement implements Serializable {
    ...
    public HeartRateMeasurement(byte[] value) {
        ...
        // Parse the flags
        int flags = parser.getIntValue(BluetoothBytesParser.FORMAT_UINT8);
        ...
        // Parse heart rate
        this.pulse = (unit == 0) ? parser.getIntValue(BluetoothBytesParser.FORMAT_UINT8) : parser.getIntValue(BluetoothBytesParser.FORMAT_UINT16);
    }
